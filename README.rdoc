...
For more about the changes made to OAuth1.0a please see <a href="http://mojodna.net/2009/05/20/an-idiots-guide-to-oauth-10a.html">Seth's Idiot's Guide to OAuth 1.0a</a>.
...
We need to add support for the oauth_verifier parameter. Make sure it looks like this:
